define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'contract/money/index' + location.search,
                    add_url: 'contract/money/add',
                    edit_url: 'contract/money/edit',
                    multi_url: 'contract/money/multi',
                    import_url: 'contract/money/import',
                    table: 'user_money',
                }
            });
            ...
            var table = $("#table");
            var type=[];
            $.ajax({url: "contract/money/gettype", async:false, success: function(obj){type = obj;}});
            // 初始化表格
