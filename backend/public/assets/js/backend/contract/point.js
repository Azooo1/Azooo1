define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'contract/point/index' + location.search,
                    add_url: 'contract/point/add',
                    edit_url: 'contract/point/edit',
                    multi_url: 'contract/point/multi',
                    import_url: 'contract/point/import',
                    table: 'user_point',
                }
            });
            ...
            var table = $("#table");
            var type=[];
            $.ajax({url: "contract/point/gettype", async:false, success: function(obj){type = obj;}});
            // 初始化表格
