define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'contract/amount/index' + location.search,
                    add_url: 'contract/amount/add',
                    edit_url: 'contract/amount/edit',
                    multi_url: 'contract/amount/multi',
                    import_url: 'contract/amount/import',
                    table: 'user_amount',
                }
            });
            ...
            var table = $("#table");
            var type=[];
            $.ajax({url: "contract/amount/gettype", async:false, success: function(obj){type = obj;}});
            // 初始化表格
