define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'contract/direct/index' + location.search,
                    add_url: 'contract/direct/add',
                    edit_url: 'contract/direct/edit',
                    multi_url: 'contract/direct/multi',
                    import_url: 'contract/direct/import',
                    table: 'user_direct',
                }
            });
            ...
            var table = $("#table");
            var type=[];
            $.ajax({url: "contract/direct/gettype", async:false, success: function(obj){type = obj;}});
            // 初始化表格
